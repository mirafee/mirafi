  ...
  return (
    ...
    <main className="flex flex-col flex-grow px-6 pt-1 ">
      <h1 className="my-3 text-base font-medium">
        ...
        Web Development and i own an <a className="text-blue-600" href="http://www.totalinfotech.ga">IT Flatform</a> ,where I teach and provide service....
      </h1>
      <div
